      ...
      >
        {!isLoading ? (
          ...
          <>
            ...
            >
              <div
                className="w-11/12 md:w-4/5 mx-auto p-2 rounded mb-3 bg-teal-500 drop-shadow grid grid-cols-2 gap-x-1 divide-x"
                id="capture"
              >
                <div className="bg-white text-lg box-border border-2 p-1">
                ...
                <div className="bg-white text-lg box-border border-2 p-1 flex flex-col justify-between">
                  <ul
                    id="survey2"
                    className="flex flex-col border border-gray-100"
                  >
